...
export const Profile = () => {
  return (
    <div>
      <>
        <div className="absolute flex h-[2050px] w-4 bg-[image:repeating-linear-gradient(315deg,_var(--pattern-foreground)_0,_var(--pattern-foreground)_1px,_transparent_0,_transparent_50%)] bg-[size:10px_10px] [--pattern-foreground:#e4e4e7] dark:[--pattern-foreground:#27272a] md:w-8" />
        <div className="relative top-0 h-[1px] w-full bg-zinc-200 dark:bg-zinc-800" />
        <div className="absolute right-0 flex h-[2050px] w-4 bg-[image:repeating-linear-gradient(315deg,_var(--pattern-foreground)_0,_var(--pattern-foreground)_1px,_transparent_0,_transparent_50%)] bg-[size:10px_10px] [--pattern-foreground:#e4e4e7] dark:[--pattern-foreground:#27272a] md:w-8" />
      </>
