...
export function AuidoItem({ title, singer, cover, handlePlay }: IProp) {
  return (
    <>
      <div
        className="w-fit transform cursor-pointer space-y-2 rounded-3xl p-4 transition-transform duration-300 hover:scale-105 hover:bg-zinc-100 hover:dark:bg-zinc-900"
        onClick={handlePlay}
      >
        {cover ? (
          <Image
