...
export function ScrollCarouselItem({
  ...
  return (
    <>
      <div
        onClick={scrollLeft}
        className="absolute left-0 top-1/2 z-50 flex h-24 -translate-y-1/2 cursor-pointer items-center rounded-r-2xl border border-white/10 bg-zinc-500/60 text-xl opacity-40 backdrop-blur-sm duration-200 hover:opacity-100 md:left-[256px]"
      >
