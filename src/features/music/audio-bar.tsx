    ...
    return (
      <AnimatePresence mode="wait">
        <motion.div
          ...
          layout
          layoutId="audio-bar"
          className="fixed inset-x-2 bottom-[85px] z-20 flex justify-center rounded-[50px] border border-transparent bg-gradient-to-tl from-transparent to-black/10 px-3 py-1 text-zinc-50 shadow-sm backdrop-blur-md dark:to-white/10 md:inset-x-96 md:bottom-4 md:rounded-[55px] md:px-4 md:py-2"
        >
          <div
            onClick={() => {
    ...
    return (
      <AnimatePresence mode="wait">
        <motion.div
          ...
          layout
          layoutId="audio-bar"
          className="fixed inset-x-20 bottom-6 z-20 flex justify-center rounded-[50px] border border-transparent bg-gradient-to-tl from-transparent to-black/10 px-3 py-1 text-zinc-50 shadow-sm backdrop-blur-md dark:to-white/10 md:inset-x-96 md:bottom-4 md:rounded-[50px] md:px-4 md:py-2"
        >
          <div
            onClick={() => {
              if (window.innerWidth < 768) {
