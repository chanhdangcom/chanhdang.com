...
export function ComponentPage({ slug }: { slug: string }) {
  ...
  return (
    <div>
      ...
      <div className="prose prose-base prose-zinc mx-2 max-w-none font-sans text-foreground dark:prose-invert prose-h2:my-4 prose-h2:border-b prose-h2:border-zinc-300 prose-h2:pb-2 prose-h3:my-4 prose-a:font-mono prose-ul:font-mono prose-ul:text-sm prose-ul:text-zinc-500 dark:prose-h2:border-zinc-900 md:mx-48">
