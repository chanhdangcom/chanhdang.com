...
export function TitleIntro() {
  ...
  return (
    ...
    >
      <div>
        <p className="pointer-events-none top-0 mx-4 font-mono text-xs text-zinc-500 md:mx-[25vw]">
        ...
        <h1
          ...
          className="mx-4 text-balance font-mono text-3xl font-semibold leading-tight tracking-tight md:mx-[25vw] md:text-4xl"
        >
          {t("titleintro.Title")}
        </h1>
