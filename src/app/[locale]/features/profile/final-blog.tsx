...
export function FinalBlog() {
  return (
    <section aria-labelledby="blog-heading">
      ...
      <div className="mx-4 flex items-center justify-between text-balance font-mono text-3xl font-semibold leading-tight tracking-tight md:mx-[25vw] md:text-4xl">
