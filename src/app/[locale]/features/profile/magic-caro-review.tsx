...
export function MagicCaroReview() {
  ...
  return (
    <section aria-labelledby="components-heading">
      <div className="mb-8">
        <p className="top-0 mx-4 font-mono text-xs text-zinc-500 md:mx-[25vw]">
        ...
        <Link href={`/${locale}/magic-caro`}>
          <h2
            ...
            className="flex text-balance px-4 font-mono text-3xl font-semibold leading-tight tracking-tight hover:underline md:mx-[25vw] md:px-0 md:text-4xl"
          >
            Magic Caro
          </h2>
        </Link>
      ...
      <div className="mx-0 px-4 py-4 md:mx-[25vw] md:px-20">
