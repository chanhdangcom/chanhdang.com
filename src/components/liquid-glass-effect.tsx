...
class Shader {
  ...
  private constrainPosition(x: number, y: number) {
...
function createLiquidGlass() {
  ...
  if ((window as unknown as { liquidGlass?: Shader }).liquidGlass) {
    (window as unknown as { liquidGlass?: Shader }).liquidGlass?.destroy();
  ...
  (window as unknown as { liquidGlass?: Shader }).liquidGlass = shader;
}
