  ...
  return (
    <div className="relative left-0 top-0 mx-auto w-full max-w-7xl px-4 py-20 md:py-40">
      ...
      <p className="mt-8 max-w-2xl text-base dark:text-neutral-200 md:text-xl">
        ...
        SQL Server, hỗ trợ quản lý bán hàng, bàn, thức uống và hóa đơn một cách
    ...
    >
      <a href={product.link} className="block group-hover/product:shadow-2xl">
        <img
          ...
          height="600"
          width="600"
          className="absolute inset-0 h-auto w-full object-cover object-left-top"
          alt={product.title}
        />
      </a>
      <div className="pointer-events-none absolute inset-0 h-full w-full bg-black opacity-0 group-hover/product:opacity-80"></div>
      <h2 className="absolute bottom-4 left-4 text-3xl font-semibold text-white opacity-0 group-hover/product:opacity-100">
        {product.title}
      </h2>
    </motion.div>
  );
